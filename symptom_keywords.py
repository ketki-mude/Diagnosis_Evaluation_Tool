# Create the symptom_keywords.csv file with the provided symptoms

import pandas as pd

# List of symptoms as provided
symptoms = [
    ...
    "loss_of_balance", "unsteadiness", "weakness_of_one_body_side", "loss_of_smell", "bladder_discomfort", "foul_smell_of_urine", 
...
symptom_df = pd.DataFrame(symptoms, columns=["keywords"])
symptom_df.to_csv("symptom_keywords.csv", index=False)

# Verify that the CSV is created
symptom_df.head()
